...
<html>
    ...
    <body style="background:#f1f1f1;">
            ...
            <div class="row">
                <div class="col-sm-5 pt-5 mx-auto">
                    ...
                    <?php if(isset($_GET['register'])){?>
                        <div id="notifikasi-sukses">
                            <div class="alert alert-success">
                                <strong>Register Berhasil, Silahkan login dengan username dan password yang didaftarkan</strong>
                            </div>
                        </div>
                        <?php }?>
                    <div class="card">
        ...
        <?php }?>
            ...
            var registerberhasil = function(){
                $("#notifikasi-sukses").fadeOut('slow');
            };
            setTimeout(registerberhasil, 4000);
        </script> 
    </body>
</html>